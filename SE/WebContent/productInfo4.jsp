            ...
            <div class="row align-items-center">
        	 <div class="col-lg-3 ml-auto">
         	 <form class="input-icon my-3 my-lg-0" action="#">
                  <input type="search" class="form-control header-search" name="searchcontent"   placeholder="Search&hellip;" tabindex="1" value="输入框内容">
              ...
              <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item">
                    <a href="./productInfo.jsp" class="nav-link active"><i class="fa fa-connectdevelop"></i>&nbsp;科技&nbsp;</a>
                  </li>
                  <li class="nav-item">
                     <a href="./productInfo1.jsp" class="nav-link"><i class="fa fa-empire"></i>&nbsp;动漫&nbsp;</a>
                  </li>
                  <li class="nav-item">
