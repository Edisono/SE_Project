...
public class MessageAction extends ActionSupport {
	...
	public String add() throws SQLException{
		...
		switch (mobjtype) {
		case 0:
			NewsInfo news = (NewsInfo)request.getSession().getAttribute("news");
			mobjid=news.getNid();
			mobjtitle=news.getNtitle();
			break;
		case 1:
			ExhibitInfo exhibit = (ExhibitInfo)request.getSession().getAttribute("exhibit");
		...
		case 3:
			...
			break;
		case 4:
			ProductInfo product = (ProductInfo)request.getSession().getAttribute("product");
