...
document.getElementsByTagName("title")[0].innerText = '编辑求购信息';
</script>
            ...
            <div class="row">
             ...
             <div class="card">
                <div class="card">
                  ...
                  <div class="card-body">
                  <form  action="q_update" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                          <label class="form-label">求购标题</label>
                          <input type="text" class="form-control" name="qtitle" placeholder="Title.." value="<s:property value="%{#session.q.qtitle}" />">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <textarea class="form-control" name="qcontent" rows="6" placeholder="Content.."><s:property value="%{#session.q.qcontent}" /></textarea>
                  </div>
